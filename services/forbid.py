...
def check_sign(session):
    ...
    img = url_open(url)
    try:
        os.system('rm /home/luo/my_bot/799/pic_db/check_sign_img/cdd.jpg')
    except:
        pass
    with open('/home/luo/my_bot/799/pic_db/check_sign_img/cdd.jpg','ab') as f:
        f.write(img)
...
def recog_pic():
    ...
    img_path = '/home/luo/my_bot/799/pic_db/check_sign_img/cdd.jpg'
